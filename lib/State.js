...
class State {
  ...
  set_block(name, block) {
    if (this.path) {
      this.parent.blocks[this.path] ||= {};
      this.parent.blocks[this.path][name] ||= block;
    } else {
      this.parent.blocks[name] = block;
    }
    return block;
  }
  ...
  get blocks() {
    return this.parent.blocks[this.path] || this.parent.blocks;
  }
