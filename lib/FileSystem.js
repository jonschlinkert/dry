...
// Example:
//
//   Dry.Template.file_system = Dry.LocalFileSystem.new(template_path)
...
// Example:
//
//   file_system = Dry.LocalFileSystem.new("/some/path")
//
...
// Example:
//
//   file_system = Dry.LocalFileSystem.new("/some/path", "%s.html")
//
...
class LocalFileSystem {
  ...
  read_template_file(template_path) {
    const absolute = this.full_path(template_path);
    if (!this.exists(absolute)) throw new Dry.FileSystemError(`No such template '${template_path}'`);
